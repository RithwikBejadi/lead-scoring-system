...
const automationExecutionSchema = new mongoose.Schema({
  leadId: { type: mongoose.Schema.Types.ObjectId, required: true, ref: "Lead", index: true },
  ruleId: { type: mongoose.Schema.Types.ObjectId, required: true, ref: "AutomationRule" },
...
automationExecutionSchema.index({ leadId: 1, ruleId: 1, dateBucket: 1 }, { unique: true });
